window.uploadimagefilename="";

function setClickImage(imagepath){
	$('#loader_img').attr('src',imagepath);
...
$(document).ready(function() {
    ...
    $(".clickimageimg").on("click", clickImageTapHandler);
        ...
        $('#MyUploadForm').submit(function() {
                ...
                // return false to prevent standard browser submit and
                // page navigation
                return false;
        });
        ...
        function OnProgress(event, position, total, percentComplete) {
                ...
                progressbar.width(percentComplete + '%') // update
                                                                                                        ...
                                                                                                        // percent
                                                                                                        // complete
                statustxt.html(percentComplete + '%'); // update status
                                                                                                // text
                if (percentComplete > 50) {
                        statustxt.css('color', '#fff'); // change status
                                                                                        // text to white
                                                                                        // after 50%
                }
        }
        ...
        function afterSuccess(data) {
                ...
                window.uploadimagefilename=data;
                setClickImage(window.uploadimagefilename);
        }
